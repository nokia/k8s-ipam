...
func init() {
	SchemeBuilder.Register(&NodeModel{}, &NodeModelList{})
}

// Node type metadata.
var (
	NodeModelKind             = reflect.TypeOf(NodeModel{}).Name()
	NodeModelGroupKind        = schema.GroupKind{Group: GroupVersion.Group, Kind: NodeModelKind}.String()
	NodeModelKindAPIVersion   = NodeModelKind + "." + GroupVersion.String()
	NodeModelGroupVersionKind = GroupVersion.WithKind(NodeModelKind)
)
