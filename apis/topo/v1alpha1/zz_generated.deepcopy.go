...
func (in *InterconnectLink) DeepCopyInto(out *InterconnectLink) {
	*out = *in
	...
	if in.LogicalLinkIndex != nil {
		in, out := &in.LogicalLinkIndex, &out.LogicalLinkIndex
		*out = new(int)
		**out = **in
	}
	if in.Links != nil {
...
func (in *InterconnectLinkEndpoint) DeepCopyInto(out *InterconnectLinkEndpoint) {
	*out = *in
	...
	if in.LogicalEndpointName != nil {
		in, out := &in.LogicalEndpointName, &out.LogicalEndpointName
		*out = new(string)
		**out = **in
	}
...
func (in *SelectorPolicy) DeepCopyInto(out *SelectorPolicy) {
	*out = *in
	if in.MultiHomedNodes != nil {
		in, out := &in.MultiHomedNodes, &out.MultiHomedNodes
		*out = new(uint32)
		**out = **in
	}
}
