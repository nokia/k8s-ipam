...
func (in *AddressClaimCOntext) DeepCopyInto(out *AddressClaimCOntext) {
	*out = *in
	if in.AddressSelectorLabels != nil {
		in, out := &in.AddressSelectorLabels, &out.AddressSelectorLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.AddressUserDefinedLabels != nil {
		in, out := &in.AddressUserDefinedLabels, &out.AddressUserDefinedLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *PrefixClaimContext) DeepCopyInto(out *PrefixClaimContext) {
	*out = *in
	if in.PrefixSelectorLabels != nil {
		in, out := &in.PrefixSelectorLabels, &out.PrefixSelectorLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.PrefixUserDefinedLabels != nil {
		in, out := &in.PrefixUserDefinedLabels, &out.PrefixUserDefinedLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	in.AddressClaimCOntext.DeepCopyInto(&out.AddressClaimCOntext)
}
