...
func (r *VLANIndex) GetCondition(ct resourcev1alpha1.ConditionType) resourcev1alpha1.Condition {
...
// BuildVLANIndex returns a VLANIndex from a client Object a crName and
// an VLANIndex Spec/Status
