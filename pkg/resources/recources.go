...
type Resources interface {
	...
	GetExistingResources(ctx context.Context, cr client.Object, ml client.MatchingLabels) error
...
func (r *resources) GetExistingResources(ctx context.Context, cr client.Object, ml client.MatchingLabels) error {
	r.m.Lock()
	defer r.m.Unlock()
