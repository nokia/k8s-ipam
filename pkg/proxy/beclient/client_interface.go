...
type Client interface {
	...
	CreateIndex(ctx context.Context, cr client.Object) error
	// Delete deletes the cache instance in the backend
	DeleteIndex(ctx context.Context, cr client.Object) error
	// Get returns the claimed resource
	GetClaim(ctx context.Context, cr client.Object, d any) (client.Object, error)
	// Claim claims a resource
	Claim(ctx context.Context, cr client.Object, d any) (client.Object, error)
